...
- Prove UI changes on the selected worktree's Portless preview. Use development mode for hot
  reload and production mode at the final commit for acceptance evidence. Start with
  `ops/local-previews.md` and `.agents/skills/browser-validation/SKILL.md`.
