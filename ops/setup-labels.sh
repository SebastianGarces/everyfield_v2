...
gh label create "needs-spec"        --color 5319E7 --description "Not yet fleshed out — Sebastian and the agent talk it through before it can queue" --force
...
# or question. Those three ship with every GitHub repo, so nothing creates them
# here — a --force on them would only rewrite GitHub's own descriptions.
