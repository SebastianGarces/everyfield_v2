...
<!-- EVERYFIELD-PRODUCT-START -->[Product Docs Index]|root:./product-docs|FRDs define requirements, checklists track implementation status.|prd.md,product-brief.md,system-architecture.md,core-data-contracts.md|features/wiki:{frd.md,checklist.md}|features/people-crm:{frd.md,checklist.md}|features/communication-hub:{frd.md,checklist.md}|features/task-project-management:{frd.md,checklist.md}|features/meetings:{frd.md,checklist.md}|features/ministry-team-management:{frd.md,checklist.md}|features/financial-tracking:{frd.md,checklist.md}|features/facility-management:{frd.md,checklist.md}|features/document-templates:{frd.md,checklist.md}|features/progress-dashboard:{frd.md,checklist.md}|features/phase-engine:{frd.md,checklist.md,rubric-v0.md,data-posture.md,wave-plan.json}|features/church-plant-agent:{vision.md}<!-- EVERYFIELD-PRODUCT-END -->
