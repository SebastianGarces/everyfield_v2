...
<!-- EVERYFIELD-MEMORY-START -->[Memory Index]|root:./memory|CRITICAL: Check memory BEFORE opening source files. Contains architecture contracts and invariants.|entrypoints.md,invariants.md,index.md|contracts:{api.md,db.md,config.md}|flows:{auth.mmd,wiki-article.mmd,request-lifecycle.mmd}<!-- EVERYFIELD-MEMORY-END -->

<!-- EVERYFIELD-SKILLS-START -->[Skills Index]|root:./.agents/skills|Read SKILL.md first for each skill, then reference files as needed.|email-best-practices:{SKILL.md,resources/transactional-emails.md,resources/deliverability.md,resources/compliance.md}|next-best-practices:{SKILL.md,async-patterns.md,data-patterns.md,error-handling.md,rsc-boundaries.md,suspense-boundaries.md}|react-email:{SKILL.md,references/COMPONENTS.md,references/PATTERNS.md,references/STYLING.md}|resend:{SKILL.md,send-email/SKILL.md,send-email/references/best-practices.md}|ui-ux-pro-max:SKILL.md|vercel-react-best-practices:{SKILL.md,AGENTS.md,rules/*}|web-design-guidelines:SKILL.md<!-- EVERYFIELD-SKILLS-END -->

<!-- EVERYFIELD-PRODUCT-START -->[Product Docs Index]|root:./product-docs|FRDs define requirements, checklists track implementation status.|prd.md,product-brief.md,system-architecture.md,core-data-contracts.md|features/wiki:{frd.md,checklist.md}|features/people-crm:{frd.md,checklist.md}|features/communication-hub:{frd.md,checklist.md}|features/task-project-management:{frd.md,checklist.md}|features/meetings:{frd.md,checklist.md}|features/ministry-team-management:{frd.md,checklist.md}|features/financial-tracking:{frd.md,checklist.md}|features/facility-management:{frd.md,checklist.md}|features/document-templates:{frd.md,checklist.md}|features/progress-dashboard:{frd.md,checklist.md}<!-- EVERYFIELD-PRODUCT-END -->
