...
- Accepted residual: `P-024a` and `P-024b` are cited in code and here but resolve to nothing in `product-docs/features/people-crm/frd.md`, which defines only `P-024` ("Photo support"). Retired when the FRD grows the sub-requirement rows.
