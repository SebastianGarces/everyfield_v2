...
| Undo the unsubscribe | `src/app/unsubscribe/actions.ts:undoUnsubscribeAction()` → `applyEmailOptIn()` | Undo button, spends a ~1h `enable` token |
