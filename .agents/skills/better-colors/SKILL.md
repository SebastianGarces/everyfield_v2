---
name: better-colors
description: OKLCH color space and color usage for web projects: convert hex/rgb/hsl to oklch, generate palettes, check contrast, handle gamut boundaries, theme with Tailwind v4, apply color with meaning. Triggers on oklch, color conversion, palette, contrast ratio, gamut, display p3, design tokens, dark mode colors, accent color.
---
