---
name: better-layout
description: Layout structure for web interfaces: grouping, alignment, reading order, progressive disclosure, adaptive breakpoints. Use when structuring a page or component, spacing controls, or reviewing frontend code for layout. Triggers on layout, spacing, alignment, whitespace, visual hierarchy, progressive disclosure, breakpoints, responsive layout, container queries, RTL.
---
