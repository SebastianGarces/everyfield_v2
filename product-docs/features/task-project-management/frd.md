...
> **Tracked on the board:** [F5 #86](https://github.com/SebastianGarces/everyfield_v2/issues/86) — open requirements are its sub-issues. Implementation status is not tracked in this file.
