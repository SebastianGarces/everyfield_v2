...
| EV-042 | **Help on request.** Empty conversations show one welcoming question without sample-request lists. Asking what Evry can do produces a concise explanation of supported application work and its permission and confirmation boundaries. | “What can you do for me?” receives a helpful reply without reading application records or proposing a change. Completed conversations do not append sample requests. |
