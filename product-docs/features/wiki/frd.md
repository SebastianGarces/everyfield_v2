...
> **Tracked on the board:** [F1 #72](https://github.com/SebastianGarces/everyfield_v2/issues/72) — open requirements are its sub-issues. Implementation status is not tracked in this file.
