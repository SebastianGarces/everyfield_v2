...
## 2026-08-13 — Factory rulings: the pre-release risk policy (#435) and the per-site review-fix cap (#430, on PR #428)

Two rulings about the delivery factory itself, both given by Sebastian on 2026-08-13. Neither
changes product behaviour; both change what the loop is obliged to do, so they are recorded here and
applied to `ops/agent-os/dod.md`, `ops/agent-os/labels.md`, `.claude/skills/spec-intake/SKILL.md`
and `.claude/skills/dispatch/SKILL.md` in the same change.
