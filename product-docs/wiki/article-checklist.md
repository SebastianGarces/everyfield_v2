...
Track MDX components needed for articles. Create these after articles are complete.
...
| `<RoleCard>` | Leadership role summary cards | ⬜ Not Started |
| `<ProcessFlow>` | Visual flowchart/funnel diagrams | ⬜ Not Started |
| `<QuickReference>` | Collapsible quick reference sections | ⬜ Not Started |
| `<RelatedArticles>` | Styled related articles links | ⬜ Not Started |
| `<TemplateDownload>` | Download button for templates | ⬜ Not Started |
