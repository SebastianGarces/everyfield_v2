...
const paths = git("ls-tree", "-r", "--name-only", baseline, "src/components/evry")
...
console.log(`Reviewed chat markup preserved in ${paths.length} components against ${baseline}.`);
