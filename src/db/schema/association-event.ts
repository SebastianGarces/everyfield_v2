...
// 0036). Until 0036 the subject was `church_id`, NOT NULL, and the third
...
export const associationEvents = pgTable(
  "association_events",
  {
     ...
     * what every row written before migration 0036 is, and because a raw INSERT
     ...
     *
     * Nullable since 0036 — not because a null means "global content" (the
