...
--   DELETE FROM drizzle.__drizzle_migrations WHERE created_at = 1786330802116;
--
...
-- used to say `WHERE hash = '<0035 hash>'` and call that hash the sha256 of
...
-- silently pre-0035 with the ledger still claiming otherwise. The value below
