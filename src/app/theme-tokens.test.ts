...
//
// Four siblings, one subject each, over the shared math in `./theme-color`:
...
//   · status-badge-scale.test.ts — the #429 person-status badges, whose colours
//     come from Tailwind's own palette rather than from any token here
// ----------------------------------------------------------------------------
