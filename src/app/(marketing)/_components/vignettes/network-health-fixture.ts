...
const REDEMPTION_HILL_INSIGHTS = [
  {
    ...
    body: "Ensure prayer coverage is established. This crucial component is essential for spiritual unity and readiness as launch approaches.",
