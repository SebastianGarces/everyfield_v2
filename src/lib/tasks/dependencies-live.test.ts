...
// running this where a real database is configured (and 0043 has been
// applied):
//
...
const SKIP_NOTE =
  "SKIPPED — the live T-015 assertions did NOT run. No reachable DATABASE_URL, or migration 0043 has not been applied. Run `pnpm db:migrate` in a worktree with .env.local linked.";
