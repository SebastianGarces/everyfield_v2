...
5. Produce insights for BOTH audiences:
   ...
   THAT DEVICE IS UNAVAILABLE IN A LENS THE FACTS REPORT AS \`evidence.<lens>.quality = unknown\`: nothing "positive" may be written there, for either audience (see the rubric's evidence-quality section). Pair a concern in such a lens with an "info" insight — which does take a focus slot — or leave it out.
