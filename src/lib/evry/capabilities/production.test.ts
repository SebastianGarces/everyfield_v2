...
test("production installs every Communication, Launch, Meetings, and People effect together", () => {
  const effectIdentities = [
    ...communicationInventory.capabilities,
    ...launchInventory.capabilities,
...
test("production composes every Communication, Launch, Meetings, and People review exactly once", () => {
  const effectIdentities = [
    ...communicationInventory.capabilities,
    ...launchInventory.capabilities,
    ...meetingsInventory.capabilities,
